...
namespace PeliculasWeb.Controllers
{
    public class ActoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ActorId,Personaje,NombreActor,Edad,Nacionalidad")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ActorId,Personaje,NombreActor,Edad,Nacionalidad")] Actor actor)
        {
            if (id != actor.ActorId)
            {
                return NotFound();
