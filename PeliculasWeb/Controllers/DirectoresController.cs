...
namespace PeliculasWeb.Controllers
{
    public class DirectoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DirectorId,Nombre,Nacionalidad,Edad,PremiosGanados")] Director director)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DirectorId,Nombre,Nacionalidad,Edad,PremiosGanados")] Director director)
        {
